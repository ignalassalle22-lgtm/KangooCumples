...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ar="http://ar.gov.afip.dif.FEV1/">
  ...
  // Usar https nativo con SECLEVEL=0 para compatibilidad con DH keys pequeñas de AFIP
  const httpsModule = (await import('node:https')).default
  const parsed = new URL(url)

  return new Promise((resolve, reject) => {
    const agent = new httpsModule.Agent({ ciphers: 'ALL:!DHE:@SECLEVEL=0', minVersion: 'TLSv1' })
